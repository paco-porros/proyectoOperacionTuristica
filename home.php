...
<body class="altura-minima columna-flexible sin-desbordamiento-horizontal">
  ...
  <nav class="navegacion">
    ...
    <div class="navegacion__enlaces">
      <a class="navegacion__enlace" href="home.php#planes">Planes Turísticos</a>
      <a class="navegacion__enlace" href="home.php#gastronomia">Ofertas Gastronómicas</a>
      <a class="navegacion__enlace" href="home.php#servicios">Servicios</a>
  ...
  ═══════════════════════════════════════════ -->
  <section class="seccion-itinerarios" id="planes">
  ...
  ═══════════════════════════════════════════ -->
  <section class="seccion-gastronomia" id="gastronomia">
    <div class="contenedor-gastronomia">
      ...
      <div class="cuadricula-gastronomia" id="cuadricula-gastronomia">
        <!-- Skeletons mientras carga -->
        <div class="tarjeta-gastro" style="opacity:.4;pointer-events:none;">
          <div class="tarjeta-gastro__imagen-envoltorio" style="background:#d5b9b2;"></div>
