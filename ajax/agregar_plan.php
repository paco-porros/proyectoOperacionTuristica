<?php
/**
 * ajax/agregar_plan.php — RESERVAR PLAN TURÍSTICO
...
/*
   BLOQUE 5 - Obtener plan turístico
   - SELECT FROM planes_turisticos WHERE id y estado='activo'
...
/*
   ...
   - SELECT reservas WHERE usuario_id Y plan_turistico_id CON estado pending/confirmado
...
/*
   ...
   - INSERT reserva: tipo_plan='turistico', estado='pendiente'
*/
